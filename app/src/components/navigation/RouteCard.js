...
export default function RouteCard({ time, distance, mode, filters, routeNo, onClick, display }) {
  return (
    <Card sx={{ width: '293px', height: '100px', top: '440px', left: '50px', borderRadius: '20px 75px 75px 20px', position: 'absolute', display: {display}, justifyContent: 'space-evenly', alignItems: 'center' }}>
